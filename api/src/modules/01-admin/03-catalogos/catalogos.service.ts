...
import { 
  CatalogosSearchDto as searchDto, 
  CatalogosCreateDto as createDto, 
  CatalogosUpdateDto as updateDto,
} from './dtos/catalogos.dto';
import { responseSuccess, responseError } from 'src/core/common/res/res.config';
import { titleHeaderReport } from './catalogos.config';


@Injectable()
export class CatalogosService {
  constructor(
    @InjectRepository(Catalogos) private readonly repository: Repository<Catalogos>,
  ) { }
