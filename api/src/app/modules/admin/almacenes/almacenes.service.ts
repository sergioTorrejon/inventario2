...
import {
  AlmacenesCreateDto as createDto,
  AlmacenesSearchDto as searchDto,
  AlmacenesUpdateDto as updateDto,
...
export class AlmacenesService {
  constructor(
    @InjectRepository(Almacenes) private readonly repository: Repository<Almacenes>,
    ) { }
/************************************************************************************************ */
