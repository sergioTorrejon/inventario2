...
} from '../categorias/categoria-empresa/categoria-empresa.service';
import {
  CategoriaRegistroService,
} from '../categorias/categoria-registro/categoria-registros.service';
import {
  CatalogoCreateDto,
  CatalogoUpdateDto,
} from './dtos';
...
export class CatalogoService {
  constructor(
    ...
    private readonly serviceCategoriasRegistros: CategoriaRegistroService,
  ...
  async getOptions() {
    const catreg = await this.serviceCategoriasRegistros.getOptions();
