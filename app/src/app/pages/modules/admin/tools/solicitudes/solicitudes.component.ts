...
import { EMPRESA_MODEL, queryGetData } from './model/solicitudes.model';
...
export class SolicitudesComponent implements OnInit {
  ...
  constructor(
    ...
    dataTableUpdate(event: any){
      ...
      const query = queryGetData((this.formGroup).getRawValue())
      this.restCrud.getData(this.model.name,query,this.page.index+1, this.page.size,this.sort, this.order)
      .subscribe((data:any) => {
