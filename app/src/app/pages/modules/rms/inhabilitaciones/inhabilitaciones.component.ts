...
import { REGISTROS } from './model/inhabilitaciones.model';

@Component({
  selector: 'app-inhabilitaciones',
  templateUrl: './inhabilitaciones.component.html',
  styleUrls: ['./inhabilitaciones.component.css'],
})
export class inhabilitacionesComponent implements OnInit {
  // CONFIGURACION
  model=REGISTROS
  ...
  constructor(
    ...
    public rest: InhabilitacionesService,
    ...
    private _snackBar: MatSnackBar
      ...
      this.rest.getEmpresas().subscribe((data:any) => {
  ...
  formOnchange(){
      ...
      this.formGroup.controls['tipoEmpresa'].valueChanges.subscribe(async data => {
        ...
        this.rest.getEmpresas(data).subscribe((data:any) => {
          this.empresas = data.data;
        });
      })
  }
