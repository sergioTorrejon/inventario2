...
import { inhabilitacionesComponent } from './inhabilitaciones.component';

@NgModule({
    declarations: [
      inhabilitacionesComponent,
      DialogInsertComponent,
      DialogUpdateComponent,
    ],
    exports: [],
    bootstrap: [inhabilitacionesComponent],
    imports: [
        ReactiveFormsModule,
        PdfViewerModule,
        FormsModule,
        ...
        RouterModule.forChild([
            {
                path: '',
                component: inhabilitacionesComponent
            },
        ])
    ]
})
